...
namespace TestWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            // Retrieve the ApplicationUser and check if it's not null
            ...
            {
                // Handle the case where ApplicationUser is null (e.g., log an error or redirect)
                return RedirectToAction("Index"); // or handle as appropriate
            }
        ...
        public IActionResult SummaryPost()
        {
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0)
            {
                ...
                ShoppingCartVM.OrderHeader.PaymentStatus = SD.PayemntStatusPending;
                ShoppingCartVM.OrderHeader.OrderStatus = SD.StatusPending;
            }
            else
            {
                //it is a company user
                ShoppingCartVM.OrderHeader.PaymentStatus = SD.PayemntStatusDelayedPayment;
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            if (orderHeader.PaymentStatus != SD.PayemntStatusDelayedPayment)
            {
                ...
                if (session.PaymentStatus.ToLower() == "paid")
                {
                    ...
                    _unitOfWork.OrderHeader.UpdateStatus(id, SD.StatusApproved, SD.PayemntStatusApproved);
                    _unitOfWork.Save();
                }
            }
