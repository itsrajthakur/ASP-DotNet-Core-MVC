...
namespace TestWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult ShipOrder()
        {
            ...
            orderHeader.ShippingData = DateTime.Now;
        ...
        public IActionResult CancelOrder()
        {
            ...
            if (orderHeader.PaymentStatus == SD.PayemntStatusApproved)
            {
        ...
        public IActionResult PaymentConfirmation(int orderHeaderId)
        {
            ...
            if (orderHeader.PaymentStatus == SD.PayemntStatusDelayedPayment)
            {
                ...
                if (session.PaymentStatus.ToLower() == "paid")
                {
                    ...
                    _unitOfWork.OrderHeader.UpdateStatus(orderHeaderId, orderHeader.OrderStatus, SD.PayemntStatusApproved);
                    _unitOfWork.Save();
                }
            }
        ...
        public IActionResult GetAll(string status)
        {
            ...
            {
                case "pending":
                    objOrderHeader = objOrderHeader.Where(u => u.PaymentStatus == SD.PayemntStatusDelayedPayment);
                    break;
                case "inprocess":
